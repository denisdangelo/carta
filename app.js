...
function sorteio(){
    ...
    //sorteio do indice da array (vetor)
    ...
    //determinar a cor com base no nipe sorteado (preto ou vermelho)
    let cor
    ...
    //reindenizar o canto superior esquedo da carta
    ...
    //a linha abaixo muda o css refetente a tag identificada
    document.getElementById('supEsq').style.color = cor

    //reindenizar o centro da carta
    ...
    cc.innerHTML = `${nipeSorteado}`
    cc.style.color = cor
    //reindenizar o canto inferior direito da carta
...
//lição de casa fazer esse sorteio sem vetor  
//